...
with known_books(series_slug, series_name, total_books, book_order, title, match_title, author_key) as (
	values
		...
		('wings-of-fire', 'Wings of Fire', 15, 1, 'The Dragonet Prophecy', 'the dragonet prophecy', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 2, 'The Lost Heir', 'the lost heir', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 3, 'The Hidden Kingdom', 'the hidden kingdom', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 4, 'The Dark Secret', 'the dark secret', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 5, 'The Brightest Night', 'the brightest night', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 6, 'Moon Rising', 'moon rising', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 7, 'Winter Turning', 'winter turning', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 8, 'Escaping Peril', 'escaping peril', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 9, 'Talons of Power', 'talons of power', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 10, 'Darkness of Dragons', 'darkness of dragons', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 11, 'The Lost Continent', 'the lost continent', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 12, 'The Hive Queen', 'the hive queen', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 13, 'The Poison Jungle', 'the poison jungle', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 14, 'The Dangerous Gift', 'the dangerous gift', 'sutherland'),
		('wings-of-fire', 'Wings of Fire', 15, 15, 'The Flames of Hope', 'the flames of hope', 'sutherland'),
