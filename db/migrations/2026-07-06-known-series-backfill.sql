...
values
	...
	('Shadow and Bone', 'shadow-and-bone', 3, '{"source":"known-series-v1"}'::jsonb),
	('Six of Crows', 'six-of-crows', 2, '{"source":"known-series-v1"}'::jsonb),
...
with known_books(series_slug, series_name, total_books, book_order, title, match_title, author_key) as (
	values
		...
		('shadow-and-bone', 'Shadow and Bone', 3, 1, 'Shadow and Bone', 'shadow and bone', 'bardugo'),
		('shadow-and-bone', 'Shadow and Bone', 3, 2, 'Siege and Storm', 'siege and storm', 'bardugo'),
		('shadow-and-bone', 'Shadow and Bone', 3, 3, 'Ruin and Rising', 'ruin and rising', 'bardugo'),
		('six-of-crows', 'Six of Crows', 2, 1, 'Six of Crows', 'six of crows', 'bardugo'),
		('six-of-crows', 'Six of Crows', 2, 2, 'Crooked Kingdom', 'crooked kingdom', 'bardugo'),
...
with known_books(series_slug, book_order, title, match_title, author_key) as (
	values
		...
		('shadow-and-bone', 1, 'Shadow and Bone', 'shadow and bone', 'bardugo'),
		('shadow-and-bone', 2, 'Siege and Storm', 'siege and storm', 'bardugo'),
		('shadow-and-bone', 3, 'Ruin and Rising', 'ruin and rising', 'bardugo'),
		('six-of-crows', 1, 'Six of Crows', 'six of crows', 'bardugo'),
		('six-of-crows', 2, 'Crooked Kingdom', 'crooked kingdom', 'bardugo'),
